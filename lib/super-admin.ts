 ...
 * admin butuh akses LINTAS sekolah (approve pendaftaran sekolah baru),
 * sesuatu yang sistem RLS multi-tenant kita sengaja TIDAK izinkan buat
 * role manapun di dalam `profil`.
 */
